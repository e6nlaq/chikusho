...
function gen() {
	...
	const two = ["を食べてた", "をしてた", "を見てた", "を壊した", "を舐めた", "がキモかった", "かと思った", "を感じた", "を見つけた", "がした", "に逃げた", "で反省した", "で現金送った", "に喧嘩売った", "に寄付した", "が反省した", "でダンスした"];
	const thr = ["臆病", "味付き", "コンセント", "index", "ふすま", "群馬帝国", "最悪", "山梨", "さかな", "青だぬき", "偽物", "本物", "Google", "マジもん", "詐欺", "68円", "虫歯", "フリーWi-Fi", "有罪", "チー牛", "異常", "手遅れ", "超能力", "神"];
